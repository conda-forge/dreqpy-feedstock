...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dreqpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15569&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dreqpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dreqpy` can be installed with:

```
conda install dreqpy
```

It is possible to list all of the versions of `dreqpy` available on your platform with:
